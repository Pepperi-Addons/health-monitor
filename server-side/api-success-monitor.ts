...
export async function run_collect_data(client: Client, request: Request) {
    ...
    let papiClient = monitorSettingsService.papiClient;
...
export async function collect_data(client: Client, request: Request) {
    ...
    try {
        ...
        errors.push({ object: 'ActualUsers', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error')});
    }
    ...
    try {
        ...
        errors.push({ object: 'Accounts', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'Items', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'Catalogs', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'Contacts', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'Buyers', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'Profiles', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'TransactionTypes', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'ActivityTypes', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'AccountTypes', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'TransactionFields', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'ActivityFields', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'TransactionLinesFields', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'ItemFields', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'AccountFields', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'UserDefinedTables', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'WorkingUsers', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'Transactions', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'Activities', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'TransactionLines', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'Images', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
    ...
    try {
        ...
        errors.push({ object: 'UserDefinedTablesLines', error: Utils.GetErrorDetailsSafe(error, 'message', 'general error') });
    }
